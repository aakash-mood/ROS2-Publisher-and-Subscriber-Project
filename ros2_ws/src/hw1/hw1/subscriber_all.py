...
class MinimalSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.subscription_name = self.create_subscription(String,'hw1/partc/name',self.callback_name,10)
        self.subscription_count = self.create_subscription(String,'hw1/partc/count',self.callback_count,10)
...
def callback_count(self, msg):
        # Fill the code here to update global variable self.count with message
        self.count = msg.data
        self.get_logger().info('I heard: name: "%s", count: %s' % (self.name, self.count))
